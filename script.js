  ...
  $('#dealForm').submit(function (event) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('.message').show();
        $('#dealForm')[0].reset();
        addNoteToDeal(dealId, 'Job is created')
    ...
    function addNoteToDeal(dealId, content) {
      fetch(`https://api.pipedrive.com/v1/notes?api_token=ceb592fc35a2ae551a5a91c8be3afefdc4cd4a94`, {
        method: 'POST',
        headers: {
